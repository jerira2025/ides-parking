            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card-box table-responsive">
                        ...
                        <a href="{{ route('admin.usuarios.create') }}" type="button" class="btn btn-round btn-primary"
                            style="color:white;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if ($user->estado)
                                            <button type="button"
                                                class="btn btn-round btn-success btn-sm">Activo</button>
                                            @else
                                            <button type="button"
                                                class="btn btn-round btn-danger btn-sm">Inactivo</button>
                                            @endif
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.usuarios.edit', $user->id) }}"
                                                class="btn btn-sm btn-round btn-primary" style="margin-right: 5px;">
