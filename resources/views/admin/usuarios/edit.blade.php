    ...
    <div class="col-md-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form action="{{ route('admin.usuarios.update', $usuario->id)}}" method="post" class="form-label-left input_mask">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="col-md-12 col-sm-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left @error('name') is-invalid @enderror"
                            id="name" name="name" value="{{$usuario->name}}" placeholder="Nombre del Usuario" value="{{ old('name') }}"
                    ...
                    <div class="col-md-6 col-sm-6 form-group has-feedback">
                        ...
                        <select class="form-control has-feedback-left" name="roles[]" id="roles">
                            ...
                            <option value="{{ $role->name }}" {{ isset($usuario) && $usuario->roles->contains('name', $role->name) ? 'selected' : '' }}>{{ $role->name }}</option>
                            @endforeach
                        </select>
                        @error('roles')
                        <span class="text-danger">{{ $message }}</span>
                    ...
                    <div class="form-group row">
                        <div class="col-md-12 col-sm-12  offset-md-5"><br><br><br>
                            <button type="submit" class="btn btn-round btn-success">Actualizar</button>
