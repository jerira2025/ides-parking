...
<form action="{{ route('tarifas.update', $tarifa) }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="number" name="precio_hora" step="0.01" class="form-control" value="{{ $tarifa->precio_hora }}">
    </div>

    <div class="mb-3">
        <label for="precio_dia" class="form-label">Precio por Día</label>
        <input type="number" name="precio_dia" step="0.01" class="form-control" value="{{ $tarifa->precio_dia }}">
    </div>
